...
export const Alert: React.FC<AlertProps> = ({ message }) => {
    return (
        <motion.div
            ...
            className="fixed top-8 left-1/2 bg-gray-700 text-gray-300 border border-gray-500 shadow-xl rounded-lg sm:px-6 px-2 py-4 z-50 flex items-center gap-3 max-w-screen w-80 sm:w-auto h-auto"
